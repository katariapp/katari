...
| `C07` | Concrete `EntryImageSource` and returned image-page media | Split by consequence: Manga reader, F03/F04 download, and F20 Immersive resolution remain type-owned mechanics; the tracker adapter is already explicit; generic cover network access now consumes the purpose-specific Cover Network Feature. | 6.5 |
