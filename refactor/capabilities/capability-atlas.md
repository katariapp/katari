...
| Source preferences, home page, metering, and WebView contracts | External integration | `ConfigurableSource`, `SourceHomePage`, `UnmeteredSource`, and WebView source interfaces | Purpose-specific Features compose settings, home, Entry WebView, and child WebView consequences. Metering remains assigned to refresh/network policy; none is a type-wide claim. |
