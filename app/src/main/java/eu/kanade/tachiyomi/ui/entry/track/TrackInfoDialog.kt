...
data class TrackerSearchScreen(
    ...
    private class Model(
        ...
        fun registerTracking(item: TrackSearch) {
            screenModelScope.launchNonCancellable { tracker.register(item, entryId) }
        }
...
private data class TrackerRemoveScreen(
    ...
    private class Model(
        ...
        fun unregisterTracking(serviceId: Long) {
            screenModelScope.launchNonCancellable { deleteTrack.await(entryId, serviceId) }
        }
    }
}
